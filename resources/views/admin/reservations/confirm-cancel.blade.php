...
<div class="max-w-md mx-auto">
    <div class="bg-white rounded-xl shadow-tech border border-gray-100 p-6">
        <div class="text-center mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Konfirmasi Pembatalan Paksa</h2>
            <p class="text-gray-600">Verifikasi identitas admin untuk membatalkan reservasi</p>
        </div>
        ...
        <form action="{{ route('admin.reservations.cancel', $reservation->id) }}" method="POST">
            ...
            <div class="flex space-x-4">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-user-shield mr-2"></i>Force Cancel
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="mt-4 text-center">
        <p class="text-xs text-gray-500">
            ...
            Tindakan ini akan membatalkan reservasi pengguna secara paksa
        </p>
    </div>
</div>
